            ...
            <div id="logo_box">
              ...
              <div className="nav_container" >
                ...
                <NavLink exact="true" to="/agency" style={({ isActive }) => ({ backgroundColor:'#ffffff',color:'black',borderBottom: isActive ? '4px solid black' : '4px solid #0D99FF',fontWeight: isActive ? 'bold' : ''})}>
                  ...
                  <NavLink exact="true" to="/cal" style={({ isActive }) => ({ backgroundColor:'#ffffff',color:'black',borderBottom: isActive ? '4px solid black' : '4px solid #0D99FF',fontWeight: isActive ? 'bold' : ''})} >
                      정산관리
                  </NavLink>
